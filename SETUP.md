...
- **Stack badges** — a starter list based on a typical CSE second-year
  curriculum plus the interests you gave me (cybersecurity, AI/ML). Swap in
  whatever you've actually used. [shields.io](https://shields.io) has a badge
  for almost every language, framework and tool if you want to add more.
